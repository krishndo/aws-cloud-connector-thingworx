...
import pl.ttpsc.appconfig.AppConfigModule;
import pl.ttpsc.fargate.FargateTaskManager;
import pl.ttpsc.redis.RedisModule;
import pl.ttpsc.redis.ThingworxClientApplication;
import pl.ttpsc.thingworx.connection.ThingworxConnection;
import pl.ttpsc.thingworx.connection.config.ThingworxClient;
import pl.ttpsc.thingworx.thingData.ThingworxThingFetcher;
import pl.ttpsc.thingworx.thingData.thing.ThingData;
import pl.ttpsc.thingworx.thingData.thing.ThingProperty;
